        ...
        while True:
            try:
                ...
                if msg is None:
                    continue
                """
                msg.key() is in binary format
                msg.key():bytes goes to AvroDeserializer.__call__, converting to dict
                Then msg.key():dict goes to dict_to_ride_record func, converting to object:{dict}
                """
